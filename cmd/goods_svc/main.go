...
import (
	...
	"github.com/needon1997/theshop-svc/internal/goodsSvc/initialize"
	"github.com/needon1997/theshop-svc/internal/goodsSvc/proto"
	"github.com/needon1997/theshop-svc/internal/goodsSvc/service"
...
func main() {
	...
	proto.RegisterGoodsServer(server, service.GoodsService{})
